                                        ...
                                        <form method="post">
                                            <?php
                                                if(isset($_POST['register'])){
                                                   ...
                                                   $insert = mysqli_query($koneksi, "INSERT INTO user (nama_lengkap,email,alamat,username,level,password) VALUES ('$nama_lengkap', '$email', '$alamat', '$username', '$level', '$password')");
