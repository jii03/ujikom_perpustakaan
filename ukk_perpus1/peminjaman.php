                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                    <a href="?page=peminjaman_edit&&id=<?php echo $data['peminjaman']; ?>" class="btn btn-primary">Edit</a>
                                    <a onclick="return confirm('Apakah anda yakin untuk menghapus kategori ini?')" href="?page=peminjaman_hapus&&id=<?php echo $data['peminjaman_id']; ?>" class="btn btn-danger">Hapus</a>
                                <?php
                                }
                                ?>
                            </td>
